...
import WordCloudGeneratorLogo from "../../public/assets/wordcloud-generator/wordcloud-generator-logo.svg";
    ...
    <div className="px-2 md:px-10 mx-auto flex justify-center items-center pt-4">
      <div className="flex flex-col items-center justify-center">
        ...
        <TypographyLead className="text-2xl text-center w-1/2">
          A dynamic Word Cloud App Generator designed specifically for Microsoft
        ...
        <div className="mt-24">
          ...
          <div className="mb-6">
            <p className="font-bold text-body text-white mb-2">
              What is the WordCloud Generator App?
            </p>
            <p className="text-white opacity-80">
              The WordCloud Generator App is a tool designed to create visually
          ...
          <div className="mb-6">
            <p className="font-bold text-body text-white mb-2">
              How do I use the WordCloud Generator App?
            </p>
          ...
          <div className="mb-6">
            ...
            <p className="text-white opacity-80">
              The WordCloud Generator App is designed for Microsoft Word,
        ...
        <p className="text-white py-8 opacity-70 text-sm">
          Copyright 2024 - Word Cloud Generator made by Florian Barbato
        </p>
      </div>
    </div>
  );
